...
3. Na caixa **de diálogo Novo** Projeto no painel esquerdo, expanda **Visual C++** e escolha Área de Trabalho **do Windows.** No painel central, escolha Aplicativo **de Console do Windows.** Em seguida, *nomeia o projeto get-started-debugging*.

     Se você não vir o modelo de projeto aplicativo de **console,** escolha o **link** Abrir Instalador do Visual Studio no painel esquerdo da **caixa** de diálogo Novo Projeto. O Instalador do Visual Studio é iniciado. Escolha a carga de trabalho **Desenvolvimento multiplaforma do .NET Core** e, em seguida, selecione **Modificar**.
...
1. Na janela **Configurar seu novo projeto,** digite ou insira *get-started-debugging* na **caixa Nome do** projeto. Em seguida, escolha **Criar**.
