...
- **Integração:**
  ...
  - Diagnóstico [`UNT0010`](https://github.com/microsoft/Microsoft.Unity.Analyzers/blob/main/doc/UNT0010.md) aprimorado para aplicar a tudo o que herda de `Component` , não apenas `MonoBehaviour` .
