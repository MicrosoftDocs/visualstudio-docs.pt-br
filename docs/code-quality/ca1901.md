...
description: Essa regra avalia o tamanho de cada parâmetro e o valor de retorno de um P/Invoke e verifica se o tamanho deles, quando marshaled para código não gerenciado em plataformas de 32 bits e 64 bits, está correto.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1901
...
|Alteração da falha|Quebrando – se o P/Invoke estiver visível fora do assembly. Não separável – se a P/Invoke não estiver visível fora do assembly.|
