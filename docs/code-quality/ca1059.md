...
description: Um membro visível externamente é um determinado tipo concreto ou expõe determinados tipos concretos por meio de um de seus parâmetros ou valor de retorno.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1059
