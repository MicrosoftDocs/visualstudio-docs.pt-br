...
description: Uma implementação de método contém caminhos de código que podem causar várias chamadas para System. IDisposable. Dispose ou um equivalente Dispose, como um método Close em alguns tipos, no mesmo objeto.
ms.date: 07/16/2019
ms.topic: reference
f1_keywords:
- CA2202
