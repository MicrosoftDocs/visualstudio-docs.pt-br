...
description: O nome de um identificador visível externamente inclui um termo para o qual existe um termo preferido, alternativo. Ou, o nome inclui o sinalizador de termo ou sinalizadores.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- UsePreferredTerms
...
|Alteração da falha|Quebra-quando acionado em assemblies<br /><br /> Não separável-quando acionado em parâmetros de tipo|
