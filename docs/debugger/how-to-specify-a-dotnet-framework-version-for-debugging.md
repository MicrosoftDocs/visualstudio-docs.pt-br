---
title: Especifique uma .NET Framework para depuração | Microsoft Docs
description: Especifique uma versão .NET Framework mais antiga para depuração. O Visual Studio depurador dá suporte à depuração de versões mais antigas do .NET Framework, bem como à versão atual.
...
ms.locfileid: "112384662"
---
# <a name="specify-an-older-net-framework-version-for-debugging-c-visual-basic-f"></a>Especificar uma versão .NET Framework mais antiga para depuração (C#, Visual Basic, F#)

O Visual Studio depurador dá suporte à depuração de versões mais antigas do Microsoft .NET Framework, bem como à versão atual. Se você iniciar um aplicativo do Visual Studio, o depurador sempre poderá identificar a versão correta do .NET Framework para o aplicativo que você está depurando. No entanto, se o aplicativo já estiver em execução e você iniciar a depuração usando Anexar ao **,** o depurador nem sempre poderá identificar uma versão mais antiga do .NET Framework. Se isso ocorrer, você receberá uma mensagem de erro, que indica
...
4. Navegue até: HKEY_LOCAL_MACHINE\Software\Microsoft\VisualStudio\10.0\AD7Metrics\Engine\\{449EC4CC-30D2-4032-9256-EE18EB41B62B}
    ...
    Se a chave não existir, clique com o botão direito do mouse em HKEY_LOCAL_MACHINE\Software\Microsoft\VisualStudio\10.0\AD7Metrics\Engine e clique em **Nova Chave**. Nomeia a nova chave `{449EC4CC-30D2-4032-9256-EE18EB41B62B}` .
