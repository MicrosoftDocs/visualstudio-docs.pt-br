...
description: Um método que trata um evento de serialização não tem a assinatura, o tipo de retorno ou a visibilidade corretos.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
|Alteração da falha|Quebra-se o método é visível fora do assembly.<br /><br /> Não separável – se o método não estiver visível fora do assembly.|
