...
description: Encontre assistência para solucionar erros e avisos nos fóruns públicos. Exibir uma lista de fóruns relacionados a dados.
...
ms.locfileid: "112425657"
---
# <a name="troubleshoot-data-access-errors-on-the-forums"></a>Solucionar problemas de erros de acesso a dados nos fóruns
...
- [Windows Forms controles de dados e a abindagem de dados](https://social.msdn.microsoft.com/Forums/windows/en-US/home?forum=winformsdatacontrols)

- [ADO.NET DataSet](https://social.msdn.microsoft.com/Forums/en-US/home?forum=adodotnetdataset)
...
- [Fórum de serviços de dados do WCF](https://social.msdn.microsoft.com/Forums/en-US/home?forum=adodotnetdataservices)

- [SQL Server fórum de acesso a dados](https://social.msdn.microsoft.com/Forums/sqlserver/en-US/home?forum=sqldataaccess)

- [LINQ to SQL fórum](https://social.msdn.microsoft.com/Forums/en-US/home?forum=linqtosql)

- [ADO.NET fórum de provedores de dados](https://social.msdn.microsoft.com/Forums/en-US/home?forum=adodotnetdataproviders)

Para obter informações sobre como solucionar problemas de conectividade com SQL Server, consulte Solucionar problemas de conexão com o [mecanismo SQL Server banco de dados .](https://social.technet.microsoft.com/wiki/contents/articles/2102.how-to-troubleshoot-connecting-to-the-sql-server-database-engine.aspx)
