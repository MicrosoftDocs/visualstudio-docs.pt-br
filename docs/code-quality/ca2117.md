...
description: Um tipo público ou protegido em um assembly com o atributo System. Security. AllowPartiallyTrustedCallersAttribute é herdado de um tipo declarado em um assembly que não tem o atributo.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2117
