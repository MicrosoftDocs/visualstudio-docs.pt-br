---
title: Benefício do LinkedIn Learning Visual Studio assinaturas | Microsoft Docs
author: evanwindom
ms.author: v-evwin
manager: cabuschl
...
6. Especifique seu país/região e CEP e clique em **Próximo.**
...
8. Nesta etapa, você terá a oportunidade de escolher suas áreas de interesse.  Para agilizar o processo de criação da conta, clique **em Não ter certeza ainda.  Estou aberto!**  É possível escolher essas áreas mais tarde.
...
> [!NOTE]
> Essa oferta não está incluída em Visual Studio Dev Essentials associações.

## <a name="eligibility"></a>Qualificação

| Nível de Assinatura                                                 |     Canais                                            | Benefício                                                          | Renovável?    |
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (Standard)   | VL, Azure, Retail<sup>1</sup> | 6 meses       |  Não.  Disponível apenas para novos assinantes          |
| Visual Studio Enterprise assinatura com GitHub Enterprise   | Vl | 6 meses       |  Não.  Disponível apenas para novos assinantes          |
| Visual Studio Professional (Standard) | VL, Azure, Retail                                       | 3 meses                                                            |Não.  Disponível apenas para novos assinantes         |
| Visual Studio Professional assinatura com GitHub Enterprise | Vl | 3 meses      | Não.  Disponível apenas para novos assinantes         |
...
<sup>1</sup>  *Exclui: Visual Studio Dev Essentials, NFR, NFR Basic, Visual Studio Industry Partner, Microsoft Partner Network (MPN), FTE, MCT Software & Services Developer, BizSpark, Imagine, MVP (Most Valuable Professional), RD (Diretor Regional).  MCT Software & Services.*
...
- Para assistência com vendas, assinaturas, contas e cobrança para Assinaturas do Visual Studio, entre em contato com Visual Studio [suporte a](https://my.visualstudio.com/gethelp).
...
Confira o restante dos excelentes benefícios incluídos em sua assinatura. Visite [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs) .
