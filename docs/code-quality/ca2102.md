...
description: Um membro em um assembly que não está marcado com System. Runtime. Compiladorservices. RuntimeCompatibilityAttribute ou está marcado como RuntimeCompatibility (WrapNonExceptionThrows = false) contém um bloco catch que manipula System. Exception e não contém um bloco catch geral imediatamente seguinte.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2102
