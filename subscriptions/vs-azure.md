...
- **Se alguém em sua organização** comprar assinaturas para sua organização, entre em contato com seu administrador Visual Studio [assinatura](./contact-my-admin.md) e solicite uma assinatura que fornece o crédito mensal de que você precisa.  
- **Se você tiver outra assinatura Visual Studio ativa** no mesmo nível de assinatura, poderá usá-la para configurar uma nova assinatura de crédito do Azure.  

Use a tabela Qualificação abaixo para determinar quantos créditos estão incluídos em cada tipo de assinatura.  


## <a name="convert-your-azure-subscription-to-pay-as-you-go"></a>Converter sua assinatura do Azure em Pagamento Conforme o Uso

Se você não precisar mais de uma assinatura ou crédito do Visual Studio, [](/azure/azure-resource-manager/management/move-resource-group-and-subscription) mas quiser continuar usando seus recursos do Azure, transfira seus recursos para outra assinatura do Azure ou converta sua assinatura do Azure em preços pré-pago removendo o limite de gastos. [](/azure/cost-management-billing/manage/spending-limit#remove-the-spending-limit-in-azure-portal) 

Se você não tomar uma dessas ações, sua assinatura do Azure será desabilitada e excluída 30 dias depois de receber a notificação por email.  
...
|              Visual Studio Enterprise assinatura com GitHub Enterprise               |     Crédito mensal de US$150     |                             Sim                             |
|               Visual Studio Enterprise mensal               |        Não disponível        |                                                             |
|             Visual Studio Professional Standard              |     Crédito mensal de US$ 50      |                             Sim
|              Visual Studio Professional assinatura com GitHub Enterprise              |     Crédito mensal de US$ 50     |                             Sim                             |
...
|               Visual Studio Enterprise – NFR<sup>1</sup>                 |     Crédito mensal de US$150     |                             Sim                             |
...
<sup>1</sup>  *Inclui: NFR (Not for Resale), Most Valuable Professional (MVP), RD (Diretor Regional), Visual Studio Industry Partner (VSIP) Exclui: NFR Basic*
...
Não tem certeza de qual assinatura você está usando?  [https://my.visualstudio.com/subscriptions](https://my.visualstudio.com/subscriptions?wt.mc_id=o~msft~docs)Conecte-se ao para ver todas as assinaturas atribuídas ao seu endereço de email. Se não vir todas as suas assinaturas, talvez você tenha uma ou mais atribuídas a outro endereço de email.  Você precisará entrar com esse endereço de email para ver as assinaturas.
