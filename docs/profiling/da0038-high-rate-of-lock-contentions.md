...
description: Os dados de desempenho do sistema coletados com os dados de criação de perfil indicam que ocorreu uma taxa consideravelmente alta de contenções de bloqueio durante a execução do aplicativo.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- vs.performance.38
