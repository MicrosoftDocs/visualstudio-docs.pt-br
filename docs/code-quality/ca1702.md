...
description: O nome de um identificador contém várias palavras e pelo menos uma das palavras parece ser uma palavra composta que não tem maiúsculas corretas.
ms.date: 03/28/2018
ms.topic: reference
f1_keywords:
- CA1702
...
|Alteração da falha|Quebra-quando acionada em assemblies.<br /><br /> Não separável-quando acionado em parâmetros de tipo.|
