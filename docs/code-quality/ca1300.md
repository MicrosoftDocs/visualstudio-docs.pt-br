...
description: Um método chama uma sobrecarga do método System. Windows. Forms. MessageBox. show que não assume um argumento MessageBoxoptions.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
