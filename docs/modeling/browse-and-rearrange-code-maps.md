...
|Ocultar nós não selecionados.|1. Selecione os nós que você deseja manter visíveis.<br />2. Abra o menu de atalho para os nós selecionados ou para o mapa. Escolha **Selecionar**, **Ocultar Não Selecionado.**|
|Mostrar nós ocultos.|– Para mostrar todos os nós ocultos dentro de um grupo, primeiro certifique-se de que o grupo está expandido. Abra o menu de atalho e **escolha Selecionar**, **Unhide Children**.<br />     - ou -<br />     Clique no **ícone Unhide Children** Unhide Children Icon no canto superior esquerdo do grupo (isso fica visível somente quando há ![ nós filho ](../modeling/media/dependencygraph_filtericon_hiddennodes.gif) ocultos).<br />– Para mostrar todos os nós ocultos, abra o menu de atalho para o mapa ou um nó e **escolha Selecionar**, **Desaconsinar Todos.**|
...
|-|-|
|Mostrar links entre grupos o tempo todo.|**Mostrar todos os links entre grupos.** Isso oculta links agregados entre grupos.|
|Ocultar links entre grupos o tempo todo.|**Ocultar todos os links entre grupos**|
|Mostrar somente links entre grupos para nós selecionados.|**Mostrar Links de Grupo Cruzado em Nós Selecionados**|
...
|Altere o layout dentro de um grupo.|Selecione o grupo, abra o menu de atalho, escolha **Layout** e selecione o estilo de layout desejado.<br /><br /> - ou -<br /><br /> 1. Selecione o grupo e certifique-se de que ele está expandido.<br />2. Clique no header do grupo novamente e a barra de ferramentas do grupo será exibida.<br />     ![Grafo de dependência &#45; de ferramentas do grupo](../modeling/media/dependencygraph_group.png)<br />3. Abra o layout Alterar o estilo de **layout** da lista de grupos Grafo de dependência &#45; de ferramentas do grupo &#45; layout e escolha o ![ estilo de layout que você ](../modeling/media/dependencygraph_grouptoolbar.gif) deseja.<br /><br /> **Exibição de** Lista reorganiza os membros do grupo na lista. **O Padrão do Graph** redefine o layout do grupo para o layout padrão do mapa. Para outras opções, consulte [Alterar o layout do mapa.](#Selecting)|
|Adicione um nó a um grupo.|Arraste o nó para o grupo.<br /><br /> Enquanto você arrasta o nó, Visual Studio exibe um indicador para mostrar que você está movendo o nó.<br /><br /> Também é possível arrastar nós para fora de um grupo.|
...
|Agrupar nós selecionados.|1. Selecione os nós que você deseja agrupar. Uma barra de ferramentas pop-up é exibida acima do último nó selecionado.<br />     ![Barra de ferramentas do grafo de dependência](../modeling/media/depedencygraph_toolbar.png)<br />2. Na barra de ferramentas, escolha o quarto ícone Agrupar os nós selecionados **(se** o nó for expandido, ele terá cinco em vez de quatro ícones). Digite o nome do novo grupo e pressione **Retornar**.<br />     - ou -<br />     Selecione os nós que você deseja agrupar e abra o menu de atalho para sua seleção. Escolha **Grupo**, **Adicionar Grupo Pai**, digite o nome do novo grupo e pressione **Retornar**.<br /><br /> Você pode renomear um grupo. Abra o menu de atalho do grupo e **escolha Editar**, **Propriedades** para abrir o Visual Studio janela Propriedades. Na propriedade **Rótulo,** renomeie o grupo conforme necessário.|
|Remover grupos.|Selecione o grupo ou os grupos que você deseja remover. Abra o menu de atalho para sua seleção e **escolha Grupo**, **Remover Grupo**.|
|Remova os nós de seu grupo pai.|Selecione os nós que você deseja mover. Abra o menu de atalho para sua seleção e **escolha Agrupar**, **Remover do Pai.** Isso removerá os nós até seu descendente ou para fora do grupo se eles não têm nenhum grupo de filhos.<br /><br /> - ou -<br /><br /> Selecione os nós e arraste-os para fora do grupo.|
...
> [!CAUTION]
> Antes de compartilhar um mapa que foi criado usando Visual Studio Enterprise com aqueles que usam o Visual Professional, certifique-se de que todos os elementos de código que você deseja que outras pessoas vejam sejam visíveis no mapa. Caso contrário, esses usuários não poderão recuperar elementos de código excluídos.

### <a name="add-a-node-for-a-code-element"></a>Adicionar um nó para um elemento de código

|**Para**|**Realizar estas etapas**|
|-|-|
|Adicione um novo nó genérico no local atual do ponteiro do mouse.|1. Mova o ponteiro do mouse para o local no mapa em que você deseja colocar o novo elemento de código e pressione **Inserir**.<br />     - ou -<br />     Abra o menu de atalho do mapa e **escolha Editar**, **Adicionar**, **Nó Genérico**.<br />2. Digite o nome do novo nó e pressione **Retornar**.|
|Adicione um tipo específico de nó de elemento de código no local atual do ponteiro do mouse.|1. Mova o ponteiro do mouse para o local no mapa em que você deseja colocar o novo elemento de código e abra o menu de atalho do mapa.<br />2. Escolha **Editar,** **Adicionar** e selecione o tipo de nó que você deseja.<br />3. Digite o nome do novo nó e pressione **Retornar**.|
|Adicione um tipo genérico ou específico de nó de elemento de código a um grupo.|1. Selecione o nó de grupo e abra o menu de atalho.<br />2. Escolha **Editar,** **Adicionar** e selecione o tipo de nó que você deseja.<br />3. Digite o nome do novo nó e pressione **Retornar**.|
|Adicione um novo nó do mesmo tipo e vinculado de um nó existente.|1. Selecione o elemento de código. Uma barra de ferramentas pop-up aparece acima dela.<br />     ![Barra de ferramentas do grafo de dependência](../modeling/media/depedencygraph_toolbar.png)<br />2. Na barra de ferramentas, escolha o segundo ícone Criar um nó com a mesma categoria que esse nó e adicione **um novo link a ele.**<br />3. escolha um local no mapa para colocar o novo elemento de código e clique no botão esquerdo do mouse.<br />4. Digite o nome do novo nó e pressione **Return**.|
...
3. Se a lista não incluir a categoria ou propriedade, escolha **+** na caixa **legenda** e escolha **Propriedade do nó**, categoria do **nó**, Propriedade do **link** ou **categoria do link**. Em seguida, escolha a propriedade ou a categoria. A categoria ou a propriedade agora aparece na **caixa** Legenda.
...
4. Na caixa **Legenda** , clique no ícone ao lado da categoria ou propriedade que você adicionou ou você deseja alterar.
...
5. Use a tabela a seguir para selecionar o estilo que você deseja alterar:
    ...
    |Cor do texto (uma letra "f" é exibida para mostrar o resultado)|**Primeiro**|
    |ícone|**Ícones**|

     A **caixa de diálogo Seletor de** Conjunto de Cores ou **Seletor** de Conjunto de Cores é exibida para que você selecione uma cor ou um ícone.

6. Na caixa **de diálogo Selador de Conjunto de** Cores ou **Selador de** Conjunto de Cores ou Selador de Conjunto de Ícones, faça um dos seguintes:

    |**Para aplicar um**|**Realizar estas etapas**|
    |-|-|
    |Conjunto de cores ou ícones|Abra a **lista de conjunto Selecionar** cor **(ou ícone**).  Selecione um conjunto de cores ou ícones.|
    |Cor ou ícone específico|Abra a categoria ou a lista de valores da propriedade. Selecione uma cor ou ícone.|

    > [!NOTE]
    > Você pode reorganizar, excluir ou inativar temporariamente estilos na **caixa** Legenda. Consulte [Editar a caixa Legenda](#ModifyLegend).

## <a name="edit-the-legend-box"></a><a name="ModifyLegend"></a> Editar a caixa Legenda

Você pode reorganizar, excluir ou inativar temporariamente estilos na **caixa** Legenda:
