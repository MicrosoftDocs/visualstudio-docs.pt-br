...
description: Um tipo deriva de um tipo que implementa ISerializable, e o tipo implementa o construtor de serialização, mas não chama o construtor de serialização do tipo base; ou, o tipo implementa GetObjectData, mas não chama o método GetObjectData do tipo base.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2236
