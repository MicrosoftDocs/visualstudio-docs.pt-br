...
* [Docker Desktop](https://hub.docker.com/editions/community/docker-ce-desktop-windows)
* [Visual Studio 2022 Preview](https://visualstudio.microsoft.com/vs/preview/vs2022) com o **desenvolvimento** para a Web, carga de trabalho das **Ferramentas do Azure** e/ou carga de trabalho **de desenvolvimento de plataforma cruzada do .NET Core** instalada
* [Ferramentas de desenvolvimento do .NET Core 3](https://dotnet.microsoft.com/download/dotnet-core/3.1) para desenvolvimento com o .net Core 3,1.
* [.NET 5 Development toos](https://dotnet.microsoft.com/download/dotnet-core/5.0) para desenvolvimento com o .NET 5.
::: moniker-end
