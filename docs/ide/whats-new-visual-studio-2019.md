...
> [!TIP]
> Junte-se a nós na conferência do **[Microsoft Build](https://devblogs.microsoft.com/visualstudio/the-visual-studio-family-welcomes-you-at-microsoft-build-2021/)** para saber mais sobre os recursos mais recentes do visual Studio 2019, juntamente com uma espiada no que é fornecido no [Visual Studio 2022](https://devblogs.microsoft.com/visualstudio/visual-studio-2022/).
...
Enquanto isso, aqui está um novo recurso que está atualmente em funcionamento.
...
- **Experiência do git aprimorada no Visual Studio 2019 (visualização)**
   ...
   Para obter mais informações, consulte o [controle de versão na página do Visual Studio](/visualstudio/version-control/) .
...
E, para saber mais sobre nossa próxima versão, consulte a postagem no blog do **[Visual Studio 2022](https://devblogs.microsoft.com/visualstudio/visual-studio-2022/)** ! Também apresentaremos mais informações sobre o Visual Studio 2022 na conferência do **[Microsoft Build](https://devblogs.microsoft.com/visualstudio/the-visual-studio-family-welcomes-you-at-microsoft-build-2021/)** , se você quiser se juntar a nós também.
