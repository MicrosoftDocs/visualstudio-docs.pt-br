---
description: Se uma função tiver um ponto definido no qual a depuração deve começar, esse ponto será identificado por um símbolo com uma marca SymTagFuncDebugStart.
