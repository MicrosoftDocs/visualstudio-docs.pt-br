...
| github-releases.githubusercontent.com | Desenvolvimento para Linux |
...
| "Selo" de identidade <br>(nome de usuário e avatar)<br>e <br>Configurações de roaming | app.vssps.visualstudio.com <br><br>app.vsspsext.visualstudio.com<br><br>app.vssps.visualstudio.com<br><br> ns-sb2-prod-ch1-002.cloudapp.net <br><br>az700632.vo.msecnd.net<br><br>api.vstsusers.visualstudio.com/profiles/* | 443 | Usada para exibir o nome do usuário e o avatar no IDE <br><br> Usada para garantir que as alterações de configuração atravessem de um computador para outro |
...
| Pacote NPM <br>descobrir | Skimdb.npmjs.com <br><br>Registry.npmjs.org <br><br>Api.npms.io | https/443<br><br>http/80 &<br> https/443<br>https/443 | Necessária para pesquisar pacotes NPM e usada para a instalação do pacote de script do lado do cliente em projetos da Web |
...
| Active Directory <br>Grafo | graph.windows.net | https/443 | Usada para provisionar novos aplicativos do Azure Active Directory. Também usado pelo provedor Microsoft 365 de serviços conectados ao MSGraph |
...
| Service Fabric | 1. <br>documentação. Microsoft.com<br>aka.ms <br>go.microsoft.com <br><br>2. <br>vssftools.blob.core.windows.net <br>Vault.azure.com <br>Portal.azure.com <br><br> 3. &#42; vault.azure.net<br><br> 4. <br>app.vsaex.visualstudio.com<br>&#42; .vsspsext.visualstudio.com<br>clouds.vsrm.visualstudio.com <br>clouds.visualstudio.com<br>app.vssps.visualstudio.com <br>&#42; .visualstudio.com | https/443 | 1. Documentação <br><br> 2. Criar recurso de cluster <br><br>3. A &#42; é o nome do cofre de chaves do Azure (exemplo:- test11220180112110108.vault.azure.net  <br><br>  4. O &#42; é dinâmico (exemplo: vsspsextprodch1su1.vsspsext.visualstudio.com) |
| Instantâneo <br>Depurador | 1. go.microsoft.com <br>2. management.azure.com <br> 3. &#42;.azurewebsites.net <br> 4. &#42;.scm.azurewebsites.net<br>5. api.nuget.org/v3/index.json <br>6. Endereço IP do Serviço Remoto/Servidores/FQDN | 1. https/443 <br>2. https/443  <br>3. http/80 <br>4. https/443 <br>5. https/443 <br>6. Ltda/<br> 4022 (Visual Studio versão dependente) | 1. Consultar o arquivo .json para o tamanho da SKU do serviço de aplicativo <br>2. Várias chamadas do Azure RM <br>3. Chamada de aquecimento do site por meio de  <br>4. Ponto de extremidade Kudu do Serviço de Aplicativo direcionado ao cliente <br>5. Versão da Extensão de Site de Consulta publicada no nuget.org <br>6. [depuração remota](../debugger/remote-debugging.md) |
...
| Aquisição automática de tipo do JavaScript | registry.npmjs.org | https/443 | Usado para instalar definições de tipo TypeScript para fornecer o IntelliSense para bibliotecas JavaScript populares |
| serviço Assinaturas do Visual Studio licenciamento do Assinaturas do Visual Studio | app.vssps.visualstudio.com/apis/<br/>Licensing/ClientRights | https/443 | Licenciamento para ativação online |
...
| Serviço de Pesquisa do Visual Studio | data-ai.microsoft.com/search | https/443 | Usado para fornecer o Serviço de Pesquisa Visual Studio IA habilitado na caixa `Ctrl+Q` de pesquisa |
...
Oferecemos uma opção [**de suporte de chat**](https://visualstudio.microsoft.com/vs/support/#talktous) de instalação (somente em inglês) para problemas relacionados à instalação.
