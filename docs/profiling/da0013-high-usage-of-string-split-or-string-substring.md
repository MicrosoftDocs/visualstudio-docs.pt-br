...
description: Chamadas aos métodos System.String.Split ou System.String.Substring são uma proporção significativa dos dados de criação de perfil.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- vs.performance.13
