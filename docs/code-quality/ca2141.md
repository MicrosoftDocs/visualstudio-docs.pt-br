...
description: Um método transparente de segurança chama um método em um assembly que não está marcado com o atributo APTCA, ou um método transparente de segurança atende a um LinkDemand para um tipo ou um método.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2141
