...
> [!IMPORTANT]
> Conforme mencionado acima, os dados de assinante existentes, o histórico e a ID da assinatura serão mantidos e os benefícios que eles ativarem não serão interrompidos devido a essa movimentação.  


Quando você clicar no **botão Mover Agora,** um painel de sub-saída apresentará recomendações sobre como mover suas assinaturas Enterprise e/ou Professional:

   > [!div class="mx-imgBorder"]
   > ![Painel de saída](_img/assign-github/fly-out.png)

Neste pacote, você pode revisar os assinantes afetados e especificar se gostaria de notificá-los para receber uma notificação por email após a conclusão da movimentação.  Este email informa aos assinantes que seus benefícios permanecem inalterados e incentiva-os a começar a configurar uma presença no GitHub.  

Clicar no **botão Mover assinantes** permitirá que você mova todos os   assinantes recomendados ou escolha indivíduos de uma lista.  Depois de confirmar suas seleções, levará alguns segundos para que a assinatura seja concluída. Se aplicável, você precisará executar essas etapas para Professional e Enterprise separadamente.  
...
O GitHub Enterprise é configurado e gerenciado separadamente das assinaturas do Visual Studio. Após uma assinatura Visual Studio com GitHub Enterprise, um processo de instalação de conta do GitHub Enterprise é iniciado em paralelo com (mas separado de) estabelecendo um contrato no manage.visualstudio.com [.](https://manage.visualstudio.com) O estabelecimento dessa conta do GitHub Enterprise pode demorar um pouco. 

Depois que sua empresa tiver configurado uma conta do GitHub Enterprise, os assinantes atribuídos com assinaturas do Visual Studio com o GitHub Enterprise receberão um email do GitHub notificando-os sobre a vinculação de suas assinaturas do Visual Studio. Depois que os assinantes receberem esse email, eles poderão contatar o administrador da organização do GitHub para receber um convite para a organização apropriada.

Para obter detalhes sobre GitHub Enterprise configuração, consulte a [documentação do assinante](access-github.md).   

## <a name="manage-github-enterprise-subscriptions"></a>Gerenciar assinaturas do GitHub Enterprise
Quando GitHub Enterprise assinaturas são adquiridas, o GitHub faz parcerias com clientes para ajudar a criar e configurar as organizações que acessarão o GitHub e identificarão os administradores.  Em seguida, esses administradores recebem uma notificação de que foram configuradas como administradores.  
