...
description: Nas versões 1,0 e 1,1 do .NET Framework, um método público ou protegido contém um bloco try/catch/finally. O bloco finally parece redefinir o estado de segurança e não está incluído em um bloco finally.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2124
