---
description: Não é possível conectar-se a SQL Server no nome do computador remoto *.
title: Não é possível conectar-se ao SQL Server no computador remoto | Microsoft Docs
ms.date: 11/04/2016
