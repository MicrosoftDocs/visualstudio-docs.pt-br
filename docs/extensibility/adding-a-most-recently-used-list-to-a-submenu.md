...
1. Em *TestCommandPackageGuids. cs*, adicione as seguintes linhas após as IDs de comando existentes na `TestCommandPackageGuids` definição de classe.
