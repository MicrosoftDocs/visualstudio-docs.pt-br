...
ms.locfileid: "112308357"
---
# <a name="learn-to-use-the-code-editor-with-visual-basic"></a>Saiba como usar o editor de códigos com Visual Basic

Nesta introdução de 10 minutos ao editor de códigos no Visual Studio, adicionaremos código a um arquivo para ver algumas das maneiras pelas quais o Visual Studio facilita a escrita, a navegação e a compreensão Visual Basic código.
...
> [!TIP]
> Se você ainda não tiver instalado o Visual Studio Preview, acesse a página de downloads do [Visual Studio 2022 Preview](https://visualstudio.microsoft.com/vs/preview/vs2022) para instalá-lo gratuitamente.
