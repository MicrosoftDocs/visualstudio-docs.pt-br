...
description: Uma declaração de método inclui um parâmetro formal que é um tipo derivado, e o método chama somente os membros do tipo base do parâmetro.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
