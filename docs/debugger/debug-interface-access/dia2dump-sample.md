---
description: O exemplo Dia2dump mostra como usar o Microsoft Debug interface Access Software Development Kit (DIA SDK) para consultar um arquivo PDB para obter informações.
