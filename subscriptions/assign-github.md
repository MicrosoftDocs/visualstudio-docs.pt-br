...
Se sua organização comprar assinaturas do Visual Studio com os pacotes do GitHub Enterprise após a atribuição de Visual Studio Enterprise padrão e Visual Studio Professional assinaturas, o portal de Administração conterá um recurso para ajudá-lo a mover seus assinantes existentes para o Visual Studio Enterprise correspondente com o GitHub Enterprise e/ou Visual Studio Professional com assinaturas do GitHub Enterprise.  Por exemplo, os assinantes com assinaturas Visual Studio Professional mudarão para Visual Studio Professional com as assinaturas do GitHub Enterprise. No painel da barra esquerda "visão geral", você verá o seguinte bloco:

   > [!div class="mx-imgBorder"]
   > ![Botão mover agora](_img/assign-github/move-now.png "Clique em ' mover agora ' para atualizar assinaturas para o Visual Studio com as assinaturas do GitHub Enterprise")

> [!IMPORTANT]
> Conforme mencionado acima, os dados do Assinante, o histórico e a ID da assinatura existentes serão mantidos e os benefícios que eles tiverem ativado não serão interrompidos devido a essa mudança.  
>
> Este recurso está sendo implantado em fases e pode não estar imediatamente disponível em seus contratos.

Quando você clicar no botão **mover agora** , um painel de sobrevôo apresentará recomendações sobre como mover suas assinaturas empresariais e/ou Professional:

   > [!div class="mx-imgBorder"]
   > ![Painel de sobrevôo](_img/assign-github/fly-out.png)

Neste bloco, você pode examinar os assinantes afetados e especificar se deseja notificá-los para receber uma notificação por email após a conclusão da movimentação.  Este email informa aos assinantes que seus benefícios permanecem inalterados e incentiva-os a começar a configurar uma presença no GitHub.  

Depois de clicar no botão **mover todos os assinantes** , você confirmará suas seleções e aguardará alguns segundos para que a assinatura seja concluída.  Se aplicável, você precisará executar essas etapas para Professional e Enterprise separadamente.  
...
Para obter detalhes sobre a configuração do GitHub Enterprise, consulte a [documentação do assinante](access-github.md).   
...
O GitHub está disponível no GitHub.com baseado em nuvem ou no GitHub Enterprise Server local.  Os processos para gerenciar as duas versões são diferentes.  O GitHub fornece vários tópicos de ajuda e guias de administração para ajudá-lo a gerenciar assinaturas empresariais do GitHub.  Fornecemos links para os tópicos selecionados abaixo.  
...
- Para obter assistência com vendas, assinaturas, contas e cobrança para assinaturas do Visual Studio, entre em contato com o [suporte de administração e assinaturas do Visual Studio](https://my.visualstudio.com/gethelp).
- Tem alguma dúvida sobre o Visual Studio IDE, Azure DevOps Services ou outros produtos ou serviços do Visual Studio?  Visite o [suporte do Visual Studio](https://visualstudio.microsoft.com/support/).
