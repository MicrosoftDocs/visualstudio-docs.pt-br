...
description: Um delegado que manipula um evento público ou protegido não tem a assinatura, o tipo de retorno ou os nomes de parâmetro corretos.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1009
