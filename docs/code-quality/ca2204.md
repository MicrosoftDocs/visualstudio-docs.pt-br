...
description: Uma cadeia de caracteres literal é passada como um argumento para um parâmetro localizável, ou para uma propriedade localizável, e a cadeia de caracteres contém uma ou mais palavras que não são reconhecidas pela biblioteca do verificador ortográfico da Microsoft.
ms.date: 03/28/2018
ms.topic: reference
f1_keywords:
