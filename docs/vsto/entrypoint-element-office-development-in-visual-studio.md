---
description: Cada elemento entryPoint do namespace vstav3 identifica um assembly de personalização que deve ser executado quando este aplicativo ClickOnce é instalado.
