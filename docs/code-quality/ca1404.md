...
description: É feita uma chamada ao método System. Runtime. InteropServices. Marshal. GetLastWin32Error ou à função equivalente do Win32 GetLastError, e a chamada que vem imediatamente antes não é para um método de invocação de plataforma.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
