...
description: Um método de invocação de plataforma está declarado incorretamente.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1415
...
|Alteração da falha|Não separável – se o P/Invoke que declara o parâmetro não puder ser visto fora do assembly. Quebra-se o P/Invoke que declara o parâmetro pode ser visto fora do assembly.|
