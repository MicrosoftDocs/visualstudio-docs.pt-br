...
description: Saiba como usar o editor de códigos no Visual Studio para adicionar código a um arquivo e também como escrever código, navegar até ele e refactorá-lo.
ms.date: 11/30/2017
...
Os snippets de código disponíveis variam em linguagens de programação diferentes. Você pode ver os   >  snippets de código disponíveis para sua linguagem escolhendo Editar Snippet de Inserção do **IntelliSense** e, em seguida, escolhendo a pasta  >  do idioma. Para o C#, a lista tem este aspecto:
