...
description: Uma cadeia de caracteres de recurso contém uma ou mais palavras não reconhecidas pela biblioteca do verificador ortográfico da Microsoft.
ms.date: 03/28/2018
ms.topic: reference
f1_keywords:
