...
description: Uma declaração de método de invocação de plataforma inclui um parâmetro System. Boolean ou um valor de retorno, mas o atributo System. Runtime. InteropServices. MarshalAsAttribute não é aplicado ao parâmetro ou valor de retorno.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1414
