...
description: O código que está marcado como System. Security. SecurityTransparentAttribute não recebe permissões suficientes para Assert.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
